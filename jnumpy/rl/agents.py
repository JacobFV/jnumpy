...
class RealDQN(Agent):
    ...
    def train(self, traj: Traj):
        ...
        for step in traj:
            ...
            action_next_T = jnp.Var(self.policy(step.next_obs), trainable=False)  # [B, A]
            ...
            loss_T = jnp.ReduceSum(((r_T+discount_T*jnp.StopGrad(Qnext_T)) - Qnow_T)**2,
...
class CategoricalDQN(Agent):
    ...
    def train(self, traj: Traj):
        ...
        for step in traj:
            ...
            loss_T = jnp.ReduceSum(((r_T+discount_T*jnp.StopGrad(Q_next_T)) - Q_now_T)**2,
                axis=0) + reg_loss_now_T + reg_loss_next_T  # []
            optimizer.minimize(loss_T)
